...
obs=np.array([[50,111.111111111111,30],[100,200,50],[50,200,60]])
obstacleList=[ellipsoid.Ellipsoid(obs[0][0:2],(30,30),4000,10,2),ellipsoid.Ellipsoid(obs[1][0:2],(50,50),4000,10,2),ellipsoid.Ellipsoid(obs[2][0:2],(60,60),4000,10,2)]
